...
esteh: 0,
    ...
    return new Promise(async(resolve, reject) => {
        ...
        resolve(ab)
          ...
          global.kontak2 = [
        ['6285607831412', '𝘚𝘩𝘰', 'Creator Bot', 'Creator Bot', true],
...
if (msgg) return conn.sendButton(m.chat, `${global.htki} VERIFY ${global.htka}`, msgg, `${imgr + 'Verify'}`, [['ᴄᴏᴡᴏᴋ', '/verify'],['ᴄᴇᴡᴇᴋ', '/verify']],m)
}    
